...
export default function HomePostPreview({ id }: { id: string }) {
  ...
  return (
      <div className="rounded overflow-hidden bg-[#d8d8d8] m-8 flex flex-col justify-center items-center text-center p-10">
        <h1 className="p-4 text-4xl">{post.title.toUpperCase()}</h1>
        <h2 className="text-lg px-12">{post.content}</h2>
